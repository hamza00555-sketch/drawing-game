...
export const SEED_SENTENCES: readonly string[] = [
  ...
  'بنت تبحث عن جوالها وهو بيدها',
  'رجل يركن سيارته بثلاث محاولات',
  'قطة تكسر فازة وتهرب',
  'واحد يحاول يفتح باب مقفول بقوة',
  'طفل يخبي الخضار تحت الطاولة',
  'رجل ينسى اسم صاحبه قدامه',
  'بنت تاخذ سيلفي مع أسد بالحديقة',
  'واحد يطفي الأنوار وينسى مكان السرير',
  'كلب يسرق نقانق من الشواية',
  'رجل يحاول يركب خيمة بالريح',
  'واحد يوصل متأخر ويدّعي إنه بالطريق',
  'بنت تحاول تمسك فراشة بالحديقة',
  'رجل يشتري بطيخة ثقيلة ويندم',
  'طفل يبكي لأن الآيسكريم وقع',
  'واحد يحاول يمسك دجاجة هربت من القفص',
  'رجل ينسى مفاتيحه جوا السيارة',
  'بنت ترقص فرحة بعد نتيجة الاختبار',
  'واحد يحاول يطلع من زحمة بالسوق',
  'عجوز يحكي قصة قديمة لحفيده',
  'رجل يحاول يمسك حمامة بالساحة',
  'بنت تخيط ثوبها قبل الحفلة بدقايق',
  'واحد يحاول يصلح تلفزيون معطل',
  'طفل يركب دراجته لأول مرة',
  'رجل يطارد قطته فوق السطح',
  'بنت تسقي ورد ميت وتضحك',
  'واحد يحاول يوقف سيارة بيد واحدة',
  'رجل ينام بالاجتماع وينخر',
  'طفلة ترسم عائلتها بألوان غريبة',
  'واحد يبحث عن نظارته وهي فوق راسه',
  'رجل يحاول يطبخ لأول مرة ويحرق كل شي',
  'بنت تلعب مع كلبها بالحديقة',
  'واحد يحاول يركب خزانة من إيكيا',
  'رجل يوقف بمحطة بنزين فاضية',
  'طفل يخبي لعبته من أخوه الصغير',
] as const;
